...
class UservisitorsController extends BaseController
{
    ...
    */
    ...
    public function actionVisitorslist()
    {
        ...
        $visitors_list = UserVisitors::find()->select(['visitor_mobile','create_time'])->where(['mobile'=>$mobile])
        ...
        if (empty($visitors_list)) {
            ...
            $this->returnJsonMsg('200', $visitors_list, Common::C('code', '200'));
        }                                         
    }
    ...
    public function actionCountNewvisitor()
    {
        ...
        $newvisitor = UserVisitors::find()->Where(['mobile'=>$mobile])->andWhere(['is_checked'=>0])->count('id');
