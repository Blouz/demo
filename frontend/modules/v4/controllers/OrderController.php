            ...
            if (!empty($product_ids)) {
                ...
                foreach ($goods as $k => $v) {
                    $order_detail[] = [
                        ...
                        'product_name'=>$v['name'],
                        'product_img'=>ArrayHelper::getValue(Yii::$app->params, 'imgUrl').$v['image'],
                        'num'=>$v['buy_num'],
                        'price'=>$v['price'],
                ...
                if (!empty($gift_goods)) {
                    foreach ($gift_goods as $k => $v) {
                        $order_detail[] = [
                            ...
                            'product_img'=>ArrayHelper::getValue(Yii::$app->params, 'imgUrl').$v['product_img'],
                            'num'=>1,
                            'price'=>0,
                            'attribute_str'=>$v['attr_value'],
                            //'attribute_str'=>'',
               ...
               // var_dump($order_detail);exit();
                ...
                {
                    $order['total'] = $goods_total - $dis_amount;
                }
                $pay_type = 'pay';
                if ($order['total'] <= 0) {
                    $order['total'] = 0;
