...
//        $sample_order_and_where = ['and', ['>', 'create_time', $now_day ], ['<', 'create_time', $next_day]];
       ...
       // var_dump($re);exit();
        ...
        $sms_content = $sample_info['sms_content'] .'样品码：'.$sms_code;
...
//        }
        ...
        foreach ($list as $k => $v) {
            ...
            $list[$k]['image'] = $this->_formatImg($sample_info['image']);
    ...
    public function actionOrderDetail()
    {
        ...
        if (!empty($order_info)) {
            ...
            $sample_data = [
                ...
                'sample_image'=>$this->_formatImg($sample_info['image']),
            ...
            $sample_data['shop_image'] = Common::C('imgHost').$shop_info['image'];
                //var_dump($shop_info);
            if (empty($shop_info)) {
                $this->returnJsonMsg('1205', [], Common::C('code', '1205'));
            }
