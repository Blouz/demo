...
//                 $field[] = "i500_user_order.order_info";
                 ...
                 $field[] = "i500_user_basic_info.community_name";
...
//                 $field['is_eva'] = (new Query())->select('count(id)')->from("i500_service_order_evaluation")->where("order_sn=i500_user_order.order_sn");
                if($type==0)
                {
