...
return [
    ...
    'imgUrl'         => 'http://img.test.i500m.com', //图片服务器
    'channelHost'     => 'http://channel.test.i500m.com/', //通道服务器
    'baseUrl'=>'http://social.test.i500m.com/',
    ...
    'alipay'=>[
        ...
        'cacert'    => __DIR__ .'/../vendor/alipay/cacert.pem',
        'key' => 'x7jo2q2wtwnohgxsn9enk1po8jpovtmx',
        'partner' => '2088901799749689',
        'transport' => 'http',
        'seller_id' => 'iyangpin@126.com',
        'service'   => "mobile.securitypay.pay",
        'private_key_path'	=> __DIR__ .'/../vendor/alipay/key/rsa_private_key.pem',
        'ali_public_key_path'=> __DIR__ .'/../vendor/alipay/key/alipay_public_key.pem',
    ],
];
